...
@section('title', 'Opus Web - Criação de Perfil')

@section('content')

    <div>
        <h3 class="mb-0">Criação de Perfil</h3>
                                ...
                                <div class="row m-0 py-5 px-5 caixa">
                                    @foreach($permissoes as $permissao)
                                        <div class="form-check col-3">
                                            <input name="permissoes[]" class="form-check-input" type="checkbox" id="inlineCheckbox" value="{{ $permissao->name }}">
