...
@section('title', 'Opus Web - Editar missão')
                    ...
                    <div class="cartao">
                        <div class="card-body table-responsive">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <h3 class="card-title">Editar/Atribuir missão</h3>
                                <a class="btn btn-secondary" href="{{ route('gestao') }}"><i class="bi bi-arrow-left"></i> Voltar</a>
                            </div>
                            <form method="POST" action="{{ route('gestao.update',  $missao['id']) }}">
                                @csrf
                                @method('PUT')
                                <div class="mb-3 col-2">
                                    <label for="chamado" class="form-label">Chamado</label>
                                    <input type="text" class="form-control" id="chamado" name="chamado" value="{{$chamado->id}}" readonly>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-4">
                                        ...
                                        <select name="tipo" id="tipo" class="form-select">
                                            ...
                                            <option value="8">Levantamento de Rquisitos</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-3">
                                        ...
                                        <select name="status" id="status" class="form-select">
                                            ...
                                            <option value="1">Aguradando Autorização</option>
                                            <option value="2">Aguradando Janela</option>
                                            <option value="3">Retronado ao N1</option>
                                            ...
                                            <option value="10">Expirado</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-success"><i class="bi bi-plus-circle"></i> Atribuir Missão</button>
                                </div>
                            </form>
                        </div>
                    </div>
